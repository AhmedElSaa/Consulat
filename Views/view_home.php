                ...
                <div class="carousel-track">
                    ...
                    <div class="custom-card2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-text">Adel Imam, légende du cinéma arabe.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="custom-card2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-text">Les Pyramides, dernière merveille antique du monde.</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="home-end-bg">
        <div class="home-end">
            ...
            <div class="home-end-container">
                <form action="mail.php" method="POST" class="home-end-form">
